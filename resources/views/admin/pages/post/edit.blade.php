            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h6 class="text-center">Edit Artikel</h6>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.posts.update',$item->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="image" class="col-md-2 col-form-label">Gambar
                                    <br>
                                    <img src="{{ $item->image() }}" class="img-fluid mt-2" alt="">
                                </label>
                                    ...
                                    <select name="post_category_id" id="post_category_id"
                                        ...
                                        @foreach ($post_categories as $category)
                                            <option value="{{ $category->id }}"
                                                @if ($category->id == $item->post_category_id) selected @endif>{{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <textarea name="short_description" id="short_description" cols="30" rows="4"
                                        class="form-control @error('short_description') is-invalid @enderror">{{ $item->short_description ?? old('short_description') }}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <select name="is_active" id="is_active"
                                        ...
                                        <option value="1" @if ($item->is_active == 1) selected @endif>Aktif</option>
                                        <option value="0" @if ($item->is_active == 0) selected @endif>Tidak Aktif</option>
                                    </select>
                                    @error('is_active')
                                        <div class="invalid-feedback">
                                            {{ $message }}
